...
@Component({
  selector: 'app-public-search-table',
  templateUrl: './public-search-table.component.html',
  styleUrls: ['./public-search-table.component.scss'],
})
export class PublicSearchTableComponent implements OnInit {
  @Input()
